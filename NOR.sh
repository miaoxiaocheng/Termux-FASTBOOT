...
while true; do
    ...
    case $choice in
        1)
            ...
            bash -c "$(curl -sL https://gitee.com/miaoxiaocheng/Termux-FASTBOOT/raw/main/USB.sh)"
            read -n 1 -s -r -p "按任意键返回菜单..."
            ;;
        2)
            echo -e "${CYAN}进入fastBoot功能...${NC}"
            bash -c "$(curl -sL https://gitee.com/miaoxiaocheng/Termux-FASTBOOT/raw/main/FASTBOOT2.sh)"
            read -n 1 -s -r -p "按任意键返回菜单..."
            ;;
        3)
